function make_pupil_aligned_rough(base_path,tot_file_save_path,base_path_wav,mouse,date,blocks)
...
for i=1:length(pupil_all)
    ...
    xpos = [xpos pupil_all{i}.center_position.center_column];
    ypos = [ypos pupil_all{i}.center_position.center_row];
end
