...
plot(C(1),80,'-o','color',[0, 0.4470, 0.7410]);
histogram(clusterhigh(1,:),edges,'facecolor',[0.9290, 0.6940, 0.1250]);
plot(C(2),80,'-o','color',[0.9290, 0.6940, 0.1250]);
histogram(pup_norm_30(transitionSmall),edges,'facecolor',[0.4660 0.6740 0.1880]);
...
plot(transitionSmall,pup_norm_30(transitionSmall),'.','color',[0.4660 0.6740 0.1880])
xlabel('frames');
